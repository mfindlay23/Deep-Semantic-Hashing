...
doc_shingle_sets = {}
doc_id_to_category = {}
next_prime = 379 # http://compoasso.free.fr/primelistweb/page/prime/liste_online_en.php
...
#       s1 = doc_shingle_sets[docs[i]]
#       s2 = doc_shingle_sets[docs[j]]
#       J = (len(s1.intersection(s2)) / len(s1.union(s2)))
      
#       # Print out the match and similarity values with pretty spacing.
#       print "  %5s --> %5s   %.2f     %.2f" % (docs[i], docs[j], estJ, J)
